...
#import "HbCommonAPIConstant.h"

@implementation HbCommonAPIConstant

/** 公共接口*/
NSString *const kCommonServiceAPI        = @"http://img2.inke.cn/";
